...
public class Bombarda extends Spell {
    public Bombarda() {
        super("bombarda", Text.translatable("magiaborras.spell.bombarda"), new EasyList<>(SpellCastType.USE),
    ...
    public Result use(ItemStack wand, WandProperties properties, PlayerEntity magicUser, World world, HitResult hit) {
        ...
        return new Result(TypedActionResult.success(wand), baseCooldown, new EasyList<>(MagiaBorras.BOMBARDA_CAST));
    }
}
